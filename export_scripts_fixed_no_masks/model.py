...
class PolicyHead(nn.Module):
    # policy head - produce estimated actions u_hat for each timestep
...
class HybridControllerModel(nn.Module):
    def __init__(
        ...
        self.policy_head = PolicyHead(d_model, m=self.m)
    ...
    def forward(self, tokens):
        ...
        u_hat = self.policy_head(h)              # (B,T,m)
